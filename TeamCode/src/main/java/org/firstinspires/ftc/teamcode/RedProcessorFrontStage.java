...
public class RedProcessorFrontStage implements VisionProcessor {
    Telemetry telemetry;
    ...
    public RedProcessorFrontStage(Telemetry telemetry) {this.telemetry = telemetry;}

    public RedProcessorFrontStage() {}
